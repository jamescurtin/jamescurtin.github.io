#	TO USE:
#	$ python photo_html_generator.py > start.txt
#	$ tr -d '\n' < start.txt > output.txt


import random

people = [33,41,46,50,55,9,11,12,20,21,28,29,32,74,87,88,89,100,109,121]
...
harvard = [33,35,40,41,49,56,58,59,64,65,71,73,76,77,79,101,105]
...
mergedlist = people + events + harvard + nature + assorted
